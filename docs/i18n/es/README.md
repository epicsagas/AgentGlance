...
Instalación autónoma desde este repositorio — incluye el marketplace `agent-glance` homónimo; sin hub.
...
| Grok Build | ✅ | ✅ | ✅ | el archivo de hooks sigue el esquema compatible con Claude; sin verificar en ejecución |
